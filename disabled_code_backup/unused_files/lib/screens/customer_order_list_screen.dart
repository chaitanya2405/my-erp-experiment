              ...
              builder: (context, snapshot) {
                ...
                final filteredOrders = _search.isEmpty
                    ...
                    : allOrdersWithInvoices.where((orderData) {
                        ...
                        return order.orderNumber.toLowerCase().contains(_search) ||
                               order.customerId.toLowerCase().contains(_search) ||
                               order.orderStatus.toLowerCase().contains(_search);
                      }).toList();
      ...
      builder: (context) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              Text('Transaction Date: ${invoice.transactionDate.toDate()}'),
              ...
              ...invoice.items.map((item) => Padding(
                ...
                child: Text('${item['product_name']} x ${item['quantity']} = ₹${item['total']}'),
              )),
              const Divider(),
